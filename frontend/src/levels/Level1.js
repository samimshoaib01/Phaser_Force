            ...
            this.createQuestionPanel(`
                    With a name that flows like a gentle stream,
                    It’s the place to find snacks and a tasty 
                    dream. Head to this spot for a savory array,
                    Where friends gather every day.`)   
                            this.setupInput();
                        ...
                        const groundLayer= map.createLayer('Ground', [forestTiles, roguelikeCityTiles, terrainTiles, tilemapTiles, tilesetFinal, element, groundRed, groundGreen, groundGravel, soda], 0, 0);
                            ...
                            if(previousPenaliites && previousPenaliites.Level=="Level1"){
